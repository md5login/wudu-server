- [Welcome to wudu-server](#welcome-to-wudu-server)
...
- [Documentation](#documentation)
    ...
    * [Response.cookies](#responsecookies)
        ...
        + [Response.cookies.create()](#requestcookiescreate)
            - [Syntax](#syntax-11)
            - [Example](#example-11)
        + [Response.cookies.add()](#requestcookiesadd)
            - [Syntax](#syntax-12)
            - [Example](#example-12)
        + [Response.cookies.expire()](#requestcookiesexpire)
            - [Syntax](#syntax-13)
            - [Example](#example-13)
- [TODOs](#todos)
