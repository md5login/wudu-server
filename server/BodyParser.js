...
export default class BodyParser {
    static MAX_PAYLOAD_SIZE = 4194304; // 4MB
        ...
        return new Promise((resolve, reject) => {
            ...
            request
                .on('data', chunk => {
                    ...
                    // find all indices of boundary in the payload with cursor offset
    ...
    static async getMultipart (request, maxSize = BodyParser.MAX_PAYLOAD_SIZE) {
        let payloadChunks = await this.#extractPayloadChunks(request, maxSize);
